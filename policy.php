...
die vom Bediener erhalten über die Besucher der Website <?php echo $_SERVER['SERVER_NAME']?>.
...
Ihre Verfügbarkeit im Internet Netzwerkadresse <?php echo $_SERVER['SERVER_NAME']?>;
...
Benutzer – jeder Besucher der Website <?php echo $_SERVER['SERVER_NAME']?>;
...
Auch der Betreiber hat das Recht, dem Benutzer Benachrichtigungen über neue Produkte und Dienstleistungen, Sonderangebote und verschiedene Events. Der Benutzer kann jederzeit den Erhalt von Informationsnachrichten, indem Sie dem Bediener eine E-Mail an E-Mail-policy@<?php echo $_SERVER['SERVER_NAME']?>  mit dem Vermerk «Verzicht Meldungen über neue Produkte und Dienstleistungen und Sonderangebote».
...
Der Betreiber verarbeitet die personenbezogenen Daten des Benutzers nur im Falle Ihrer Befüllung und/oder senden der von dem Benutzer durch spezielle Formen, die sich auf der Website <?php echo $_SERVER['SERVER_NAME']?> . Füllende entsprechende Form und/oder durch das senden Ihre persönlichen Daten an den Betreiber, der Benutzer sein Einverständnis mit dieser Politik.
...
Im Falle von Ungenauigkeiten in den persönlichen Daten, der Benutzer kann Sie selbst pflegen und aktualisieren, indem Sie die Richtung der Bediener eine Benachrichtigung an die E-Mail-Adresse des policy@<?php echo $_SERVER['SERVER_NAME']?> mit dem Vermerk «Aktualisierung persönlicher Daten».
Die Dauer der Verarbeitung personenbezogener Daten ist unbegrenzt. Der Benutzer kann jederzeit seine Einwilligung in die Verarbeitung personenbezogener Daten durch den Betreiber eine Benachrichtigung per E-Mail auf E-Mail-Adresse des Betreibers policy@<?php echo $_SERVER['SERVER_NAME']?>  mit dem Vermerk «Widerruf der Einwilligung in die Verarbeitung personenbezogener Daten».
...
Schlussbestimmungen
Der Benutzer kann jede Aufklärung über die Fragen im Zusammenhang mit der Verarbeitung seiner personenbezogenen Daten durch Kontaktaufnahme mit dem Betreiber per E-Mail policy@<?php echo $_SERVER['SERVER_NAME']?>.
In diesem Dokument wird reflektiert alle änderungen der Verarbeitung personenbezogener Daten die Betreiber. Die Richtlinie gilt auf unbestimmte Zeit bis zu der neuen Version ersetzen.
 Die aktuelle Version der Richtlinie in der public Domain befindet sich im Internet unter der Adresse <?php echo $_SERVER['SERVER_NAME']?>/policy.php.
</pre>
</div>
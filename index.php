...
<html lang="en">
	<head>
		...
		<title><?php if (isset($_GET['article'])) { echo $matches[1]; } else { ?> Über Schönheit <?php } ?></title>
        <meta name="description" content="Schönheit ist unser Leben">
		<!-- Google font -->
				...
				<div class="row">
					<div class="col-md-5">
						<div class="footer-widget">
							...
							<ul class="footer-nav">
								<li><a href="./?a=4">Datenschutzerklärung</a></li>
                                <li><a href="./?a=5">Die Allgemeinen Geschäftsbedingungen</a></li>
							</ul>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved
					...
					<div class="col-md-3">
						<div class="footer-widget">
							<h3 class="footer-title">Teilen in sozialen. Netzwerken</h3>
